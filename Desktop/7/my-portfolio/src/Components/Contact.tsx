...
const Contact = () => {
    ...
    return (
        <div className="px-16 mx-20 my-10 font-mono" id="Contact">
            ...
            <div data-aos="flip-left" data-aos-duration="1000" className="w-[70%] border shadow-[0_0_10px_0_#64FFDA50] m-auto flex flex-col gap-6  border-primaryColor p-8 rounded-3xl">
